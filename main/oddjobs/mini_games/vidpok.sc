...
ENDSWITCH
	...
	vidpok_loop:
		...
		WAIT 0  // There is an infinite loop here somewhere...used to wait 5ms but it makes super high FPS flicker (> 200 FPS).
...
ELSE
	vp_hold_button_offset = VP_CARD_HEIGHT / 2.0
