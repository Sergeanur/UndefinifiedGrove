...
GF_Date_State6:  
	...
	CASE 4			
		...
		IF IS_SKIP_CUTSCENE_BUTTON_PRESSED
			...
			BREAK
		ENDIF
		IF IS_CHAR_PLAYING_ANIM scplayer BJ_STAND_START_P
			GET_CHAR_ANIM_CURRENT_TIME scplayer BJ_STAND_START_P fTemp[0]
			IF fTemp[0] = 1.0 
				TASK_PLAY_ANIM scplayer BJ_STAND_LOOP_P BLOWJOBZ 4.0 TRUE FALSE FALSE TRUE 6000
				TASK_PLAY_ANIM iGF_ped BJ_STAND_LOOP_W BLOWJOBZ 4.0 TRUE FALSE FALSE TRUE 6000
	...
	CASE 5
		...
		IF IS_CHAR_PLAYING_ANIM scplayer BJ_STAND_LOOP_P
			IF TIMERB > 6000
				TASK_PLAY_ANIM scplayer BJ_STAND_END_P BLOWJOBZ 4.0 FALSE FALSE FALSE FALSE 0
				TASK_PLAY_ANIM iGF_ped BJ_STAND_END_W BLOWJOBZ 4.0 FALSE FALSE FALSE FALSE 0
				++iSubStateStatus
			ENDIF
		ELSE
			iSubStateStatus = 6
...
GF_Date_State7:  
	...
	CASE 2
		...
		TASK_PLAY_ANIM_NON_INTERRUPTABLE iGF_ped BJ_CAR_START_W BLOWJOBZ 4.0 FALSE FALSE FALSE TRUE 0
		++iSubStateStatus	
	...
	CASE 4
		...
		IF TIMERB > 6000
			TASK_PLAY_ANIM_NON_INTERRUPTABLE scplayer BJ_CAR_END_P BLOWJOBZ 4.0 FALSE FALSE FALSE FALSE 0
			TASK_PLAY_ANIM_NON_INTERRUPTABLE iGF_ped BJ_CAR_END_W BLOWJOBZ 4.0 FALSE FALSE FALSE FALSE 0
			++iSubStateStatus
		ENDIF
	BREAK
