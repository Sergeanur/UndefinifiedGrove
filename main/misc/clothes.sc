		...
		IF NOT IS_STRING_EMPTY $shop_name
			...
			IF flag_clothes = 0
				...
				IF $shop_name = Csdesgn // VICTIM
					...
					// In case you were wondering, these t-shirt price changes are to reflect the status of Madd Dogg and OG Loc's popularity.
					//https://www.reddit.com/r/GamingDetails/comments/96j01h/gtasan_andreas_hidden_detail_related_to_rappers/
