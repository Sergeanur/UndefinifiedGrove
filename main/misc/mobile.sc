...
CONST_INT KATIE_MOBILE	  	110
CONST_INT KATIE_MOBILE2		111
CONST_INT KATIE_MOBILE3		112
CONST_INT KATIE_MOBILE4		113
CONST_INT KATIE_MOBILE5		114
CONST_INT KATIE_MOBILE6		115
CONST_INT KATIE_MOBILE7		116
CONST_INT KATIE_MOBILE8		117
		...
		IF player_is_completely_safe_for_mobile = 1
			IF timer_mobile_diff > call_delay
				...
				IF iGFCaller = KATIE
					//PRINT_HELP ( ANSWER )
					IF iCallType = CALL_DATE
						call_number = KATIE_MOBILE
						call_number += iCallRandomVariant
						IF call_number > KATIE_MOBILE8
							call_number = KATIE_MOBILE8
						ENDIF	 
					ELSE
						call_number = KATIE_DUMP
					ENDIF						
					GOSUB mobile_rings
					IF flag_player_answered_phone = 1
						SET_BIT iAgentFlags MOBILE_CALL_ANSWERED	
