...
FBOOTHR_PedState1:  
	SWITCH iSubStateStatus	 				
   	...
   	CASE 0   	      		
   		TASK_PLAY_ANIM_NON_INTERRUPTABLE this_ped FF_Sit_In_R FOOD 4.0 FALSE FALSE FALSE TRUE -1
	...
	CASE 1
		fAnim_Time = 0.0
		IF IS_CHAR_PLAYING_ANIM this_ped FF_Sit_In_R
			GET_CHAR_ANIM_CURRENT_TIME this_ped	FF_Sit_In_R fAnim_Time			
		ENDIF
...
FBOOTHR_PedState3: 
	SWITCH iSubStateStatus				
		...
		CASE 0			
			...
			ENDIF
			TASK_PLAY_ANIM_NON_INTERRUPTABLE this_ped FF_Sit_out_R_180 FOOD 99.0 FALSE FALSE FALSE FALSE -1				
			++iSubStateStatus
		BREAK 
		...
		CASE 2
			fAnim_Time = 0.0
			IF IS_CHAR_PLAYING_ANIM this_ped FF_Sit_out_R_180
				GET_CHAR_ANIM_CURRENT_TIME this_ped	FF_Sit_out_R_180 fAnim_Time
			   	IF fAnim_Time = 1.0					
