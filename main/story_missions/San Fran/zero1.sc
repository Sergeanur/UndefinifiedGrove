...
// if transmitter is dead, increment index_target, make remaining helis attack that transmitter
	 //	transmitter_overallhealth = 0
		...
		ELSE
			...
			//WRITE_LOG_INT transmitter1_health_zero1 transmitter2_health_zero1 transmitter3_health_zero1 "Here 3"
			//WRITE_LOG_INT transmitter_overallhealth transmitter4_health_zero1 transmitter4_health_zero1 "Total 4 4"
