			...
			ELSE
				...
				AND NOT IS_HELP_MESSAGE_BEING_DISPLAYED
					...
					SWITCH control_help_flag
						CASE 0
							// these were changed from conditional to forever, this breaks the mission audio
							PRINT_HELP Z4_H17  
...
//													ENDIF
				...
				IF NOT IS_CAR_DEAD oheli
					...
					IF oheli_flag = 1
						...
						oheli_goto += 30
						//WRITE_LOG_INT pcar_progress oheli_goto oheli_goto "Progress, heligoto"
						IF oheli_goto > 114
							oheli_goto = 114
						ENDIF
...
//						DETACH_OBJECT rock[oheli_rock]	0.0 0.0 0.0 FALSE
					...
					IF oheli_flag = 6
						...
						//WRITE_LOG "Oheli returning to base"
						oheli_flag++
					ENDIF
