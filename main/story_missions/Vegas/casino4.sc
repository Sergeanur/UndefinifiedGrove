				...
				AND NOT IS_CHAR_DEAD cas4_paul_ped
					...
					IF cas4_task_status = FINISHED_TASK
						...
						IF cas4_task_status = FINISHED_TASK	
							...
							//WRITE_LOG_INT cas4_who_started_fight cas4_who_started_fight cas4_who_started_fight "In area"
			...
			AND cas4_macca_with_player = 0	    
				...
				ELSE
					IF NOT  cas4_message_dsplayed = 3
						...
						IF NOT IS_MESSAGE_BEING_DISPLAYED
							PRINT (cas4_19) 7000 1 //~s~You need to find a vehicle with at least two passenger seats
