...
// Begin...
GOSUB mission_start_rsuzi

	IF HAS_DEATHARREST_BEEN_EXECUTED
		GOSUB mission_rsuzi_failed
	ENDIF

GOSUB mission_rsuzi_cleanup
...
// Michelle Locate -2570.6707 1150.7919 54.7333
...
CLEAR_AREA -2574.3032 1151.5638 54.7333 10.0 TRUE

IF NOT IS_CHAR_DEAD scplayer

	SET_CHAR_COORDINATES scplayer -2571.8267 1150.5892 54.7333  

	SET_CHAR_HEADING scplayer 156.4741  

	CREATE_PLAYER 1 -2570.0669 1150.0972 54.7333 player2

	DO_WEAPON_STUFF_AT_START_OF_2P_GAME

	GET_PLAYER_CHAR player2 p2

	SET_CHAR_HEADING p2 163.1839   

	SET_PLAYER_MODEL player2 NURGRL3
...
GOSUB rsuzi_set_camera

	SET_FIXED_CAMERA_POSITION -2572.0298 1146.8159 57.1697 0.0 0.0 0.0
	POINT_CAMERA_AT_POINT -2571.7534 1147.7306 56.8750 JUMP_CUT
...
GOTO mission_rsuzi_failed


mission_rsuzi_failed:
