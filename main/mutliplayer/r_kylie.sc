...
// Begin...
GOSUB mission_start_rkylie

	IF HAS_DEATHARREST_BEEN_EXECUTED
		GOSUB mission_rkylie_failed
	ENDIF

GOSUB mission_rkylie_cleanup
...
CLEAR_AREA -381.5365 -1425.3524 24.9571 10.0 TRUE

IF NOT IS_CHAR_DEAD scplayer 

	SET_CHAR_COORDINATES scplayer -381.3404 -1426.9022 24.9079  

	SET_CHAR_HEADING scplayer 270.0000  

	CREATE_PLAYER 1 -381.5365 -1425.3524 24.9571 player2

	DO_WEAPON_STUFF_AT_START_OF_2P_GAME

	GET_PLAYER_CHAR player2 p2

	SET_CHAR_HEADING p2 270.0000   

	SET_PLAYER_MODEL player2 GUNGRL3 
...
GOSUB rkylie_set_camera

	SET_FIXED_CAMERA_POSITION -376.3109 -1426.4360 27.8865 0.0 0.0 0.0
	POINT_CAMERA_AT_POINT -377.2638 -1426.4137 27.5841 JUMP_CUT
...
GOTO mission_rkylie_failed


mission_rkylie_failed:
