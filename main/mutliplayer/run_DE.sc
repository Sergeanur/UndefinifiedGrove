...
// Begin...
GOSUB mission_start_de_run

	IF HAS_DEATHARREST_BEEN_EXECUTED
		GOSUB mission_de_run_failed
	ENDIF

GOSUB mission_de_run_cleanup
...
mission_start_de_run:

HIDE_ALL_FRONTEND_BLIPS TRUE

LVAR_INT de_model_select
//--- KISSING VARIABLES
...
CLEAR_AREA -1520.8643 2608.2073 54.8437  10.0 TRUE

IF NOT IS_CHAR_DEAD scplayer 

SET_CHAR_COORDINATES scplayer -1520.8643 2608.2073 54.8437    

SET_CHAR_HEADING scplayer 160.0054
						
CREATE_PLAYER 1 -1518.7568 2608.2786 54.8437  player2
...
GOSUB runde_set_camera

	SET_FIXED_CAMERA_POSITION -1524.6987 2605.7795 57.8026 0.0 0.0 0.0
	POINT_CAMERA_AT_POINT -1523.8983 2606.2429 57.4224 JUMP_CUT

	GOSUB runde_fade_in

	PRINT_NOW ( RUN_02 ) 5000 1 // ~s~Free roam around the city.
	...
	PRINT_HELP_FOREVER ( RUN_XX ) // Player 2 : Push the ~H~left analog stick~w~ left or right to select a character.~N~~X~ Select~N~ // Not used in mobile
	...
	AND NOT IS_CHAR_DEAD p2
		...
		IF TIMERB > 250
			...
			AND LStickX > 100
				...
				IF de_model_select > 5

					de_model_select = 0

				ENDIF

				GOSUB de_select_model
	...
	GOTO mission_de_run_failed

mission_de_run_failed:
