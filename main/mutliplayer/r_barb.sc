...
// Begin...
GOSUB mission_start_rbarb

	IF HAS_DEATHARREST_BEEN_EXECUTED
		GOSUB mission_rbarb_failed
	ENDIF

GOSUB mission_rbarb_cleanup
...
// Barbara Locate -1390.1707 2637.5149 54.9887
...
CLEAR_AREA -1391.6161 2637.6035 54.9843 10.0 TRUE

IF NOT IS_CHAR_DEAD scplayer 

	SET_CHAR_COORDINATES scplayer -1391.6161 2637.6035 54.9843  

	SET_CHAR_HEADING scplayer 129.2336  

	CREATE_PLAYER 1 -1390.8789 2636.4153 54.9843 player2

	DO_WEAPON_STUFF_AT_START_OF_2P_GAME

	GET_PLAYER_CHAR player2 p2

	SET_CHAR_HEADING p2 129.2336   

	SET_PLAYER_MODEL player2 COPGRL3
...
GOSUB rbarb_set_camera

	SET_FIXED_CAMERA_POSITION -1395.2365 2633.9392 57.8633 0.0 0.0 0.0
	POINT_CAMERA_AT_POINT -1394.4982 2634.5420 57.5606 JUMP_CUT
...
GOTO mission_rbarb_failed


mission_rbarb_failed:
