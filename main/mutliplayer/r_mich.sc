...
// Begin...
GOSUB mission_start_rmichelle

	IF HAS_DEATHARREST_BEEN_EXECUTED
		GOSUB mission_rmichelle_failed
	ENDIF

GOSUB mission_rmichelle_cleanup
...
// *****************************************************************************************
	...
	// Michelle Locate -381.6302 -1426.1240 26.0000 
	...
	CLEAR_AREA -1804.1439 1199.7733 24.1172 10.0 TRUE
	
	IF NOT IS_CHAR_DEAD scplayer 

		SET_CHAR_COORDINATES scplayer -1804.1439 1199.7733 24.1172  

		SET_CHAR_HEADING scplayer 184.5768  

		CREATE_PLAYER 1 -1802.8077 1199.9120 24.1172 player2

		DO_WEAPON_STUFF_AT_START_OF_2P_GAME

		GET_PLAYER_CHAR player2 p2

		SET_CHAR_HEADING p2 184.5768   

		SET_PLAYER_MODEL player2 MECGRL3
	...
	GOSUB rmichelle_set_camera

	SET_FIXED_CAMERA_POSITION -1802.8945 1194.6371 27.1164 0.0 0.0 0.0
	POINT_CAMERA_AT_POINT -1802.9690 1195.5677 26.7584 JUMP_CUT

	GOSUB rmichelle_fade_in
	...
	GOSUB rmichelle_restore_camera
	...
	AND NOT IS_CHAR_DEAD p2
		...
		GOSUB rmichelle_keys
			
	ENDWHILE

GOTO mission_rmichelle_failed


mission_rmichelle_failed:
