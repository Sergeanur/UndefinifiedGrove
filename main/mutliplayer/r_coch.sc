...
// Begin...
GOSUB mission_start_rcoochie

	IF HAS_DEATHARREST_BEEN_EXECUTED
		GOSUB mission_rcoochie_failed
	ENDIF

GOSUB mission_rcoochie_cleanup
...
// Michelle Locate 2402.4358 -1715.4941 13.1328 
...
CLEAR_AREA 2401.5952 -1720.3112 12.6137 10.0 TRUE

IF NOT IS_CHAR_DEAD scplayer 

	SET_CHAR_COORDINATES scplayer 2401.5952 -1720.3112 12.6137   

	SET_CHAR_HEADING scplayer 180.0000  

	CREATE_PLAYER 1 2403.4053 -1720.3046 12.6171 player2

	DO_WEAPON_STUFF_AT_START_OF_2P_GAME

	GET_PLAYER_CHAR player2 p2

	SET_CHAR_HEADING p2 180.0000   

	SET_PLAYER_MODEL player2 GANGRL3
...
GOSUB rcoochie_set_camera

	SET_FIXED_CAMERA_POSITION 2402.6848 -1728.0101 15.5387 0.0 0.0 0.0
	POINT_CAMERA_AT_POINT 2402.6982 -1727.0242 15.3723 JUMP_CUT

	GOSUB rcoochie_fade_in
...
GOTO mission_rcoochie_failed


mission_rcoochie_failed:
