...
CONST_INT KATIE_NOT_AT_HOME		14
...
CONST_INT KATIE_BONUS_ACTIVE	24
...
WAIT 75
	...
	IF IS_PLAYER_PLAYING player1
		IF flag_player_on_mission = 0
			...
			IF IS_BIT_SET iGFAvailableFor2Player KATIE
...
triad_casino_script_cut2:
	...
	IF IS_PLAYER_PLAYING player1	
		SET_PLAYER_CONTROL player1 OFF
		SWITCH_WIDESCREEN ON	     
		SET_FIXED_CAMERA_POSITION 1954.571 1041.494 993.1794 0.0 0.0 0.0 //Triad Casino house
		POINT_CAMERA_AT_POINT 1954.962 1042.414 993.1676 JUMP_CUT
